...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        try {
            ...
            setMessage("Registration successful! An OTP has been sent to your email.");
        ...
        <div className="container center-container">
            <div className="card shadow-lg p-4">
                ...
                <form onSubmit={handleRegister}>
                    <div className="mb-3">
                        <label className="form-label">Full Name</label>            <input type="text"
                            name="name"
                    ...
                    <div className="mb-3">
                        <label className="form-label">Email</label>            <input type="email"
                            name="email"
                            className="form-control"
                ...
                <div className="mt-3 text-center">
                    <p>Already have an account? <a href="/login">Login here</a></p>       </div>     </div>
            {isOtpModalOpen && (
                <div className="modal d-block" style={{ background: "rgba(0,0,0,0.5)" }}>
                    <div className="modal-dialog">
                        <div className="modal-content">
                            <div className="modal-header">
                                <h5 className="modal-title">Verify OTP</h5>               <button className="btn-close"
                                ...
                                <label className="form-label">Enter OTP</label>                <input type="text"
                                    className="form-control"
                                ...
                                <button className="btn btn-primary" onClick={handleVerifyOtp}>
                                     ValidateOTP                 </button>                <button className="btn btn-secondary"
